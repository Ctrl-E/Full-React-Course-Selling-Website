...
import photoURL from "../../../src/assets/home/girl.jpg";
...
export const NavBar = () => {
  ...
  return (
    <motion.nav
      ...
      className={`${
        isHome ? navBg : "bg-white dark:bg-black backdrop:backdrop-blur-2xl"
      } ${
      ...
      <div className="lg:w-[95%] mx-auto sm:px-6 lg:px-6">
        <div className="px-4 py-4 flex items-center justify-between">
          ...
          <div
            ...
            className="cursor-pointer flex-shrink-0 pl-7 md:p-0 flex items-center"
          >
            <div>
          ...
          {/*Nav Links*/}
          <div className="hidden md:block text-black dark:text-black">
            <div className="flex">
